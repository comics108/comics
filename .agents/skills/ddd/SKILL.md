...
name: ddd
description: >-
  Document-Driven Development (DDD) flow. Use when building features that require stakeholder communication, mini-presentations, and document-first workflows.
---
