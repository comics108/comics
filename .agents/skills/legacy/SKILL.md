...
name: legacy
description: >-
  Legacy code reverse engineering documentation flow. Use to analyze existing codebases and automatically generate documentation (ADR, SDD, PDD, DDD, TDD, VDD flows).
---
